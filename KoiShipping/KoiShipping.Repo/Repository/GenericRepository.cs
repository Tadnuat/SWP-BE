...
namespace KoiShipping.Repo.Repository
{
    public class GenericRepository<TEntity> where TEntity : class
    {
        internal KoiShippingContext context;
        internal DbSet<TEntity> dbSet;

        public GenericRepository(KoiShippingContext context)
        {
    ...
    int? pageSize = null)
        ...
        public virtual void SoftDelete(TEntity entityToDelete)
        {
            ...
            var propertyInfo = entityToDelete.GetType().GetProperty("DeleteStatus");


            if (propertyInfo != null && propertyInfo.PropertyType == typeof(bool))
            {
 
                var currentDeleteStatus = (bool)propertyInfo.GetValue(entityToDelete);


                if (currentDeleteStatus)
                {
                    throw new InvalidOperationException("Cannot soft delete the entity because it is already marked as deleted.");
                }


                propertyInfo.SetValue(entityToDelete, true);
            ...
            {
                throw new InvalidOperationException("The entity does not have a 'DeleteStatus' property of type bool.");
            }
        }
